...
raisedCard.innerHTML = `
    <p>${total_pledged.toLocaleString('en-US')}</p>
`;
...
const displayStr = `A total of $${total_pledged.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, ${numberOfUnfundedGames} games remain unfunded. Help us fund these amazing games!`;


// create a new DOM element containing the template string and append it to the description container
const companydescription = document.createElement('p');

companydescription.textContent = displayStr;
...
topGameElement.textContent = `Top Pledge Game: ${topGame.name}`;
firstGameContainer.appendChild(topGameElement);

// do the same for the runner up item
const runnerUpGameElement = document.createElement('p');
runnerUpGameElement.textContent = `Runner-Up Game: ${runnerUpGame.name}`;
